...
(define (morpheus-more-exploits-gambit)
  (convo
   ...
   (once-choice (annoy-choice "I've turned remote control into an artform." "He clearly is unused to sharing the limelight. Nevertheless you explain, in detail, how you turned your school computer room into an 8-bit cartoon rave, backed by clicking tape relays. Not your greatest achievment, technically speaking, but hilarious fun." morpheus-more-exploits-gambit))
   (once-choice (annoy-choice "I wrote the first ever 6502 virus for the BBC Micro." "He seems to prefer talking about his own exploits. You patiently explain how your malware attached itself to a timer interrupt and injected itself into BASIC code, hidden within a comment using VDU control codes. This really is rather good stuff, and you have no problem expanding on the topic at length." morpheus-more-exploits-gambit))
